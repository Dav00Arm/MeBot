...
I have created a chatbot that allows you to chat with me even when I'm not available. This chatbot acts as my personal biography, interacting with users, including HR professionals and others, who want to learn more about me. It answers questions based on my detailed bio, showcasing my skills with large language models, my experience, and my ability to execute end-to-end projects. The chatbot is built using the Flan-T5-base model, which has 250 million parameters and has been fine-tuned with a custom-generated dataset specific to my background and expertise. This project demonstrates my proficiency in developing sophisticated AI solutions and highlights my technical capabilities.
